...
public class RoutingInformation implements Serializable {
    ...
    private FinalDestination finalDestination; // variable is final. Value will never Change
    private FinalDestination tempFinalDestination; // variable is not final. Value can change if a FinalDestination and their Parkingslots are all full.
    private List<FinalDestination> possibleFinalDestinations; // List of all FDs to which the user did not drive to
    private Destination dumpDestination;
    ...
    public Destination getDumpDestination() {
        return dumpDestination;
    }

    public void setDumpDestination(Destination dumpDestination) {
